...
This report presents the work conducted during a five-month end-of-studies engineering internship carried out at \textbf{IBM Client Innovation Center (CIC) Morocco}, in collaboration with \textbf{Hakkoda}, a data engineering consultancy specializing in Snowflake platform modernization, recently acquired by IBM. The host project involves the ARYZTA data platform---a Snowflake-based data ecosystem serving the operational and analytical needs of one of the world's largest industrial bakery companies.
...
The objectives of this internship were therefore threefold: first, to conduct a rigorous audit of the environment discrepancies and identify their root causes; second, to design and implement a comprehensive synchronization strategy to bring all three environments into alignment; and third, to establish a fully automated \gls{cicd} pipeline integrated with GitHub, capable of enforcing governed, reproducible deployments across the environment lifecycle.
...
\begin{itemize}
  \item \textbf{Chapter 1 --- General Context of the Project} introduces the host organizations (IBM CIC Morocco and Hakkoda), the client (ARYZTA), the project background, its objectives, the identified risks, and the Agile project management approach adopted.
  ...
  \item \textbf{Chapter 3 --- Solution Design} (forthcoming) presents the architectural decisions and technical design choices underlying the synchronization strategy and CI/CD pipeline.
  \item \textbf{Chapter 4 --- Implementation} (forthcoming) details the technical realization of the proposed solution, including the pipeline implementation, scripting, and integration with GitHub Actions.
  \item \textbf{Chapter 5 --- Results and Evaluation} (forthcoming) assesses the outcomes of the implementation against the stated objectives and discusses perspectives for future evolution.
\end{itemize}
